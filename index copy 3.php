          ...
          <div class="box">
            ...
            <div class="class-details">
              ...
              <div class="flex">
                ...
                <a href="sign-in-page.php" name="add_to_cart" class="add-to-cart-btn"><i class="fa-solid fa-cart-plus"></i></a>
              </div>
            </div>
          </div>
        </div>
...
<section class="about-section">
  <div class="about-title">
    ...
    <h2>Contact Us</h2><br>
    <p>Have questions or need assistance? Our dedicated customer service team is here to help. Reach out to us anytime, and we'll be delighted to assist you.</p>
    <br>

    ...
    <div class="cart-summary">
      <div class="cart-total">
        ...
        <div class="summary-breakdown">
            <div class="summary-item">Subtotal: PHP <span id="subtotal"><?php echo $cartTotal; ?></span></div>
            <div class="summary-item">Delivery Fee: PHP <span id="delivery-fee">0.00</span></div>
            <!-- <div class="summary-item">Discount: PHP 0.00</div> -->
            <div class="summary-total">Grand Total: PHP <span id="total"><?php echo $cartTotal; ?></span></div>
        </div>
    ...
    <input type="hidden" name="total_amount" id="total_amount_input" value="<?php echo $cartTotal; ?>">
          <div class="address-details">
            <h3>Delivery Address</h3>
              <div class="dropdown">
                  <select id="saved-address" name="saved-address" onchange="toggleAddressInput()">
                      <option value="">Choose from Addresses</option>
              ...
              <div>
                  <div class="dropdown">
                      <select id="city-dropdown" name="city-dropdown" onchange="updateBarangays()">
                  ...
                  <div class="dropdown">
                      <select id="barangay-dropdown" name="barangay-dropdown" onchange="updateDeliveryFee()">
                          <option value="">Select Barangay</option>
                      </select>
                      <input type="text" id="barangay-text" name="barangay" style="display:none;">
                  </div>
                  <input type="text" name="house_num" placeholder="House Number" oninput="markAsNewAddress()">
                  <input type="text" name="street" placeholder="Street" oninput="markAsNewAddress()">
                  <input type="text" name="landmark" placeholder="Landmark/Other Address Information" oninput="markAsNewAddress()">
        ...
        <div id="checkout-container">
            <button class="sh_btn" id="checkout-btn">Proceed to Checkout</button>
        </div>
        </form>
    </div>
    <?php

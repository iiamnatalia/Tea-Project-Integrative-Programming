            ...
            document.getElementById('search-form').submit();
                    ...
                    <section class="">
                        <div class="box-container">
                            ...
                            <div id="newProductForm" style="<?php echo isset($_GET['edit_name']) ? 'display: block;' : 'display: none;'; ?>">
                                ...
                                <form action="staff-products-add-update.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div id="editProductForm" style="display: none;">
                                <form action="staff-products-add-update.php" method="POST" enctype="multipart/form-data" onsubmit="enableSelectAndSubmit(this); return false;">
                    ...
                    <script>
                        ...
                        function archiveProduct(productId) {
                            $.ajax({
                                url: 'staff-products-archive-process.php',
                                type: 'POST',
                                data: {
                                    pid: productId
                                },
                        ...
                        function unarchiveProduct(productId) {
                            $.ajax({
                                url: 'staff-products-unarchive-process.php',
                                type: 'POST',
                                data: {
                                    pid: productId
                                },
                        ...
                        function loadArchivedProducts() {
                            $.ajax({
                                url: 'staff-products-fetch-archived.php',
                                type: 'GET',
                                success: function(response) {

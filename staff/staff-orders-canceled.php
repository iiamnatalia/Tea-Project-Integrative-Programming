            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="staff-orders-canceled.php">Canceled Orders</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    ...
                    <ul class="nav nav-tabs" id="orderTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="to-be-refunded-tab" data-toggle="tab" href="#toberefunded" role="tab" aria-controls="toberefunded" aria-selected="true">To be Refunded</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="orderTabsContent">
                        <?php
                        $orderStatuses = ['To be Refunded', 'Canceled', 'Refunded'];
                        foreach ($orderStatuses as $status):
                            ...
                            ?>
                                ...
                                <div class="card-body">
                                    <?php if ($order['order_status'] != 'Canceled' && $order['order_status'] != 'Refunded'): ?>
                                    <form action="staff-orders-update-status.php" method="POST">
                                        
                                        <div class="form-group">
                                            <label for="order_status">Update Order Status:</label>
                                            <div class="flex">
                                                <select class="form-control" id="order_status" name="order_status">
                                                    <option value="To be Refunded" <?php echo ($order['order_status'] == 'To be Refunded') ? 'selected' : ''; ?>>To be Refunded</option>
